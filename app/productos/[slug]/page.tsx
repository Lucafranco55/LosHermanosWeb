...
const fallbackUses = "Producto elaborado para uso automotor, técnico y comercial.";
        ...
        <section className="mt-6 grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="rounded-[2rem] border border-brand-100 bg-white p-6 shadow-card sm:p-8">
            ...
            <div className="mt-7 space-y-4">
              <InfoCard icon={<CheckCircle2 className="h-5 w-5" />} title="Descripción ampliada">
                {product.fullDescription || fallbackUses}
              </InfoCard>
              <InfoCard icon={<Wrench className="h-5 w-5" />} title="Usos recomendados">
                {fallbackUses}
              </InfoCard>
              <InfoCard icon={<Package className="h-5 w-5" />} title="Presentación / formato">
